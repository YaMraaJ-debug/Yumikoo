...
bg_path = "./Yumikoo/Helper/resources/userinfo.png"
font_path = "./Yumikoo/Helper/resources/Yumikoo.ttf"
...
@Yumikoo.on_message(filters.command(["info", "userinfo"]))
async def userinfo(_, message):
    ...
    if not message.reply_to_message and len(message.command) == 2:
        try:
            ...
            await Yumikoo.send_photo(chat_id, photo=welcome_photo, caption=INFO_TEXT.format(
        ...
        try:
            ...
            mention = user.mention
            bio = user_info.bio
            photo = await Yumikoo.download_media(message.reply_to_message.from_user.photo.big_file_id)
            welcome_photo = await get_userinfo_img(
                bg_path=bg_path,
                font_path=font_path,
                user_id=user_id,
...
@Yumikoo.on_message(filters.command('id'))
...
@Yumikoo.on_message(filters.command("math", prefixes="/"))
...
@Yumikoo.on_message(filters.command("blackpink"))
